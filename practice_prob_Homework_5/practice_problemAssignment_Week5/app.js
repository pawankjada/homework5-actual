...
function printNumber() {
  $('#content').on('click', '.new', printNum); //I also tried alert($('#content').on('click', '.new', printNum)); it also worked but starts with an alert button and then print the numbers.
}